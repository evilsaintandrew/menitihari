      ...
      <div className="invitation-editor-layout">
        <section aria-label="Kontrol editor" className="invitation-editor-controls">
          <Card><CardHeader><p className="ui-overline">Quick Setup</p><h2 className="ui-card-title">Lengkapi bagian penting</h2><p className="ui-card-description">Perubahan tersimpan otomatis setelah Anda berhenti mengetik.</p></CardHeader><CardContent className="invitation-editor-form">
            ...
            <div className="invitation-editor-quick-rows" aria-label="Bagian pengaturan lain"><div><span>Events</span><TextLink href={`/invitations/${invitationId}/events`}>Kelola acara →</TextLink></div><div><span>Tamu</span><TextLink href={`/invitations/${invitationId}/guests`}>Kelola tamu →</TextLink></div><div><span>Sharing &amp; Privacy</span><TextLink href={`/invitations/${invitationId}/settings`}>Kelola →</TextLink></div></div>
          </CardContent></Card>
        </section>
